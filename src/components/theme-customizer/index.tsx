...
export function ThemeCustomizer({ open, onOpenChange }: ThemeCustomizerProps) {
  ...
  const [selectedTweakcnTheme, setSelectedTweakcnTheme] = React.useState("mono")
  ...
  const handleReset = () => {
    ...
    updateSidebarConfig({ variant: "sidebar", collapsible: "icon", side: "left" })
  }
